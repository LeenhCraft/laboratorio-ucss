...
<div id="template-customizer" class="invert-bg-white" style="visibility: visible"> <a href="javascript:customizer()" class="template-customizer-open-btn" tabindex="-1"></a>
    <div class="p-4 m-0 lh-1 border-bottom template-customizer-header">
        <h4 class="template-customizer-t-panel_header mb-2">Style (Mode)</h4>
        <a href="javascript:close()" class="btn-close template-customizer-close-btn fw-light px-4 py-2 text-body" tabindex="-1"></a>
    </div>
        ...
        <div class="template-customizer-theming">
            <div class="m-0 px-4 pb-3 pt-1 template-customizer-style w-100">
                <label class="switch switch-sm">
                    <span class="switch-label template-customizer-t-style_switch_light cursor-pointer">Light</span>
                    <input id="dark-mode-button" type="checkbox" class="switch-input">
                    <span class="switch-toggle-slider">
                        <span class="switch-on"></span>
                        <span class="switch-off"></span>
                    </span>
                    <span class="switch-label template-customizer-t-style_switch_dark cursor-pointer">Dark</span>
                </label>
            </div>
        </div>
    </div>
